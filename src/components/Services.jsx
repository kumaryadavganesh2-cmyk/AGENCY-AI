...
const ServicesData = [
  {
    title: "Advertising",
    description:
      "We turn bold ideas into powerfull digital solution that connect, engage...",
  ...
  return (
    ...
    >
      <img
        src={assets.bgImage2}
        alt=""
        className="absolute -top-110 mask-linear-from-mist-700
      -z-1 dark:hidden"
      />
      ...
      solution that move your business forward."
      />
